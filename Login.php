      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	 <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Trang chủ</a></span> <span>Login</span></p>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
						<form action='./control/process_login.php' class="dangnhap" method='POST' class="billing-form">
                ...
                <div class="w-100"></div>
                <p><input type='submit'  name="dangnhap" value='Đăng nhập' class="btn btn-primary py-3 px-4"></p>

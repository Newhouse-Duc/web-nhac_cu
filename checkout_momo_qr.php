      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	 <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Trang chủ</a></span> <span>Checkout</span></p>
    ...
    <section class="ftco-section">
      <div class="container">
        <div class="row justify-content-center">
          ...
          <form method="Post"  enctype="application/x-www-form-urlencoded" action="./Momo/Momo_qr.php">
                ...
                <div class="w-100"></div>
					...
					<p> <input type="submit" name="redirect" value=" Thanh toán MOMO QR" class="btn btn-primary py-3 px-4 d-flex justify-content-center align-items-center text-center ">  </p>
					</form>

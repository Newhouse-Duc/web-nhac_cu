    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="images/product-1.jpg" class="image-popup"><img src="<?php echo $each['img'] ?>" class="img-fluid" 
  alt="ảnh "></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h3><?php echo $each['product_name'] ?></h3>
    			
    				<p class="price"><span>Giá: <?php 
					$price = $each ['price'];
					$formatted_price = number_format($price, 0, '.', ',');
					
					echo $formatted_price ?></span>VNĐ</p>
    				<p><?php echo $each['detail'] ?>
						</p>
						<div class="row mt-4">
							<div class="col-md-6">
          	...
          	<p><a href="add_cart.php?id=<?php echo $each['id'] ?>" class="btn btn-black py-3 px-5">Add to Cart</a></p>
			<?php }?>
    			</div>
    		</div>
    	</div>
    	...
    	<div class="container">
			...
			<?php foreach ($result2 as $each2): ?>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="<?php echo $each2['img'] ?>" 
  alt="ảnh ">
    						
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#"><?php  echo $each2['product_name']?></a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span><?php $price = $each2 ['price'];
					$formatted_price = number_format($price, 0, '.', ',');
					...
					echo $formatted_price ?> </span></p>
	    					...
	    					<div class="bottom-area d-flex px-3">
								...
								<a href="product-single.php?id=<?php echo $each2['id'] ?>"class="add-to-cart d-flex justify-content-center align-items-center text-center" >
	    								<span><i class="ion-ios-menu"></i></span>
	    							</a>
	    							<a href="./control/add_cart.php?id=<?php echo $each2['id'] ?>" class="buy-now d-flex justify-content-center align-items-center mx-1">

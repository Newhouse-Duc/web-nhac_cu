...
$total_pages_sql = "SELECT COUNT(*)  FROM products WHERE category_id = '4'";
$result = mysqli_query($connect,$total_pages_sql);
$total_rows = mysqli_fetch_array($result)[0];
$total_pages = ceil($total_rows / $no_of_records_per_page);

$sql = "SELECT * FROM products where category_id = 4 LIMIT $offset, $no_of_records_per_page";
    ...
    <section class="ftco-section">
    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					...
    					<li><a href="shop_guitar.php"class="active">Guitar</a></li>
        ...
        <?php foreach ($result as $each): ?>
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="<?php echo $each['img'] ?>" 
  alt="ảnh ">

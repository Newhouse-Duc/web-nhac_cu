...
$total_pages_sql = "SELECT COUNT(*)  FROM products WHERE category_id = '1'";
$result = mysqli_query($connect,$total_pages_sql);
$total_rows = mysqli_fetch_array($result)[0];
$total_pages = ceil($total_rows / $no_of_records_per_page);

$sql = "SELECT * FROM products where category_id = 1 LIMIT $offset, $no_of_records_per_page";
    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
    					...
    					<li><a href="shop_piano.php" class="active">Piano</a></li>
